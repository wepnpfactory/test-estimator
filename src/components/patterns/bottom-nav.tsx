...
function BottomNav({ items, activeIndex = 0, maxWidth = "430px", className, ...props }: BottomNavProps) {
  return (
    <nav
      data-slot="bottom-nav"
      className={cn("fixed bottom-0 left-0 right-0 bg-card border-t border-surface-muted pb-safe", className)}
      {...props}
    >
      <div className="mx-auto flex items-center justify-around px-6 py-3" style={{ maxWidth }}>
